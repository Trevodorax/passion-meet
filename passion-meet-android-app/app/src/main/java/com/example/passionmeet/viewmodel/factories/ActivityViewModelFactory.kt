...
import com.example.passionmeet.ui.activities.DetailledActivityFragment
...
class DetailledActivityViewModelFactory (
        private val repository: ActivityRepository,
        private val activity: DetailledActivityFragment
    ) : ViewModelProvider.Factory {
